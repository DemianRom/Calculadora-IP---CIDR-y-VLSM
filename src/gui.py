...
Equipo: Demian Romero Bautista y Renata Garciía Resendiz
Grupo: 5CV1
...
class CalculadoraIPGUI:
    ...
    def configurar_estilos(self):
        ...
        estilo.configure('Title.TLabel', font=('Segoe UI', 14, 'bold'))
    ...
    def crear_pestana_vlsm(self):
        ...
        ttk.Button(frame_agregar, text="Cargar Ejemplo", 
                  command=self.cargar_ejemplo_vlsm, 
